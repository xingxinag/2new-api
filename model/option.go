...
func InitOptionMap() {
	...
	common.OptionMap["InvitationCodeRequired"] = strconv.FormatBool(common.InvitationCodeRequired)
	common.OptionMap["RedemptionCodeRequired"] = strconv.FormatBool(common.RedemptionCodeRequired)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "InvitationCodeRequired":
		common.InvitationCodeRequired = value == "true"
	case "RedemptionCodeRequired":
		common.RedemptionCodeRequired = value == "true"
